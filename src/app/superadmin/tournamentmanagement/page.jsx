...
function page() {
  return (
    <div className="tournamentmanagement w-full min-h-screen flex flex-col gap-4 pl-10 pt-10 ">
        ...
        <div>
            <button className='bg-yellow-500 text-black px-4 font-bold py-3 rounded-full'>Create New Tournament</button>
        </div>
