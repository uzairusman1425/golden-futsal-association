          ...
          <div className="content flex  flex-col items-start gap-6  justify-center sm:pl-4 lg:pl-8 w-[70%] lg:w-[60%]  h-full">
            ...
            >
              <div className="intput-1 flex items-center w-11/12 lg:w-[400px] px-2 bg-[#1f2b38] border-[1px] border-white h-[40px] rounded-3xl">
                ...
                <input
                  type="email"
                  className="outline-none text-white bg-[#1f2b38] px-2 w-[80%]"
                  placeholder="Email"
                  value={email}
                  onChange={(e) => {
              ...
              <div className="tags w-full  lg:w-[400px] flex justify-between items-center">
                ...
                <div className="forgot text-gray-400">
                  <Link href={"#"} className="text-[11px] lg:text-[16px]">
                    Forgot Password?
                  </Link>
                </div>
              </div>
              <div className="button w-full">
                {loading ? (
                  <>
                    <p className="text-white text-xl font-bold">Loading..... Please Wait </p>
                  </>
                ) : (
