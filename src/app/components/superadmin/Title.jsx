...
function Title() {
  return (
    <>
      ...
      <div className="navigation w-11/12  flex items-center gap-20 px-4 bg-primary h-14 rounded-3xl">
        <Link
        ...
        <Link className="text-gray-400 text-sm hover:text-golden  " href={"/superadmin/tournamentmanagement/knockout"}>
          KNOCKOUT
        </Link>
        <Link
          className="text-gray-400 text-sm  hover:text-golden "
