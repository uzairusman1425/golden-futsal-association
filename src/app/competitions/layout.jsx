...
export default function CompetitionLayout({ children }) {
  return (
    <>
      ...
      <section className=" hidden lg:flex  lg:w-full lg:min-h-screen lg:text-[12px] 2xl:text-[14px]">
        <SideBar />
        <section className="w-full h-max flex pt-4 bg-main items-start sticky top-0  justify-center ">
          <div className="w-[90%] min-h-screen  pt-20 flex flex-col items-start  pl-2">
      ...
      <section className="w-full min-h-screen lg:hidden flex flex-col pl-2 sm:pl-4 md:pl-10 pt-10 bg-main text-[10px] sm:text-[12px] md:text-[14px]">
        ...
        <div className="w-full h-full   text-[10px] sm:text-[12px] md:text-[14px]">
          {children}
        </div>
      </section>
    </>
