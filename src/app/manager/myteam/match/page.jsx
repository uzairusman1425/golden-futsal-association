...
function page() {
  return (
   ...
   <div className="tournament w-full h-16  flex items-center justify-between px-2">
    ...
    <select name="tournament" className='w-[250px] outline-none text-white h-10 bg-sidebar' >
    ...
    <div className="l">
        <button className='text-black font-semibold bg-yellow-500 px-4 py-2 rounded-3xl'>Join New Tournament</button>
    </div>
   </div>
