    ...
    <>
      <div className="squad w-full min-h-screen mt-4  bg-main flex flex-col gap-4">
        ...
        <table className="w-full h-full flex flex-col gap-2">
          <thead className="w-full h-12 overflow-x-auto  text-white text-[12px] font-light ">
            <tr className="w-full h-full flex items-center text-left overflow-x-auto">
              <th className="w-[25%] ">NAME</th>
              <th className="xl:w-[15%] lg:w-[20%]">POSTION</th>
              <th className="xl:w-[12%] lg:w-[15%]">PERFORMANCE</th>
              <th className="xl:w-[20%] lg:w-[25%]">STATUS</th>
              <th className="xl:w-[15%] lg:w-[18%]">JERSEY NUMBER</th>
              <th className="xl:w-[13%]">ACTION</th>
            </tr>
          </thead>
           <SquadList />
