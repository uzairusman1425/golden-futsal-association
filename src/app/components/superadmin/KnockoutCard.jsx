  ...
  return (
    ...
    <p className='text-white'>{id}</p>
     ...
     <div className="team1 w-full h-10 bg-sidebar rounded-t-md">
          <div className="number w-[35px] h-full bg-[#153b58] rounded-t-md flex items-center justify-center text-white">
              <p>{team1?team1:''}</p>
          </div>

      </div>
      <div className="team2 w-full h-10 bg-sidebar  rounded-b-md ">
      <div className="number w-[35px] h-full bg-[#153b58] rounded-b-md flex items-center justify-center text-white">
              <p>{team2?team2:''}</p>
          </div>
      </div>
     </div>
