...
function page() {
  ...
  <div className='w-full min-h-screen flex flex-col gap-8 mt-10 '>
    <div className="teams overview w-11/12 h-[150px] bg-primary flex items-center gap-2">
<div className="content w-[40%] lg:w-[30%] flex flex-col gap-4 text-white items-start pl-4 justify-center ">
  <h1 className='text-gray-400'>NEXT MATCH</h1> 

  <div className="date w-full h-max flex items-center gap-2 lg:gap-4  ">
...
<div className="team w-[60%] lg:w-[70%] flex items-center justify-center gap-4 sm:gap-6 lg:gap-10">
<div className="image1 flex flex-col  items-center">
  <Image src={rm} width={35} alt="arsenal.png"/>
